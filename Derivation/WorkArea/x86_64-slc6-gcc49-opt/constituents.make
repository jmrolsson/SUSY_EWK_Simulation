...
#cmt_local_tagfile = $(WorkArea_tag).make
cmt_local_tagfile = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_install_python_modules = $(bin)$(WorkArea_tag)_install_python_modules.make
...
cmt_local_tagfile_install_python_modules = $(bin)$(WorkArea_tag).make
...
cmt_WorkArearchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_WorkArearchk_has_target_tag

cmt_local_tagfile_WorkArearchk = $(bin)$(WorkArea_tag)_WorkArearchk.make
cmt_final_setup_WorkArearchk = $(bin)setup_WorkArearchk.make
cmt_local_WorkArearchk_makefile = $(bin)WorkArearchk.make

WorkArearchk_extratags = -tag_add=target_WorkArearchk

else

cmt_local_tagfile_WorkArearchk = $(bin)$(WorkArea_tag).make
cmt_final_setup_WorkArearchk = $(bin)setup.make
cmt_local_WorkArearchk_makefile = $(bin)WorkArearchk.make

endif

not_WorkArearchk_dependencies = { n=0; for p in $?; do m=0; for d in $(WorkArearchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
WorkArearchkdirs :
	@if test ! -d $(bin)WorkArearchk; then $(mkdir) -p $(bin)WorkArearchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)WorkArearchk
else
WorkArearchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_WorkArearchk_makefile) : $(WorkArearchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building WorkArearchk.make"; \
	  $(cmtexe) -tag=$(tags) $(WorkArearchk_extratags) build constituent_config -out=$(cmt_local_WorkArearchk_makefile) WorkArearchk
else
$(cmt_local_WorkArearchk_makefile) : $(WorkArearchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_WorkArearchk) ] || \
	  [ ! -f $(cmt_final_setup_WorkArearchk) ] || \
	  $(not_WorkArearchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building WorkArearchk.make"; \
	  $(cmtexe) -tag=$(tags) $(WorkArearchk_extratags) build constituent_config -out=$(cmt_local_WorkArearchk_makefile) WorkArearchk; \
	  fi
endif
...
$(cmt_local_WorkArearchk_makefile) : $(WorkArearchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building WorkArearchk.make"; \
	  $(cmtexe) -f=$(bin)WorkArearchk.in -tag=$(tags) $(WorkArearchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_WorkArearchk_makefile) WorkArearchk
else
$(cmt_local_WorkArearchk_makefile) : $(WorkArearchk_dependencies) $(cmt_build_library_linksstamp) $(bin)WorkArearchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_WorkArearchk) ] || \
	  [ ! -f $(cmt_final_setup_WorkArearchk) ] || \
	  $(not_WorkArearchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(WorkArearchk_extratags) build constituent_makefile -out=$(cmt_local_WorkArearchk_makefile) WorkArearchk

WorkArearchk :: $(WorkArearchk_dependencies) $(cmt_local_WorkArearchk_makefile) dirs WorkArearchkdirs
	$(echo) "(constituents.make) Starting WorkArearchk"
	@if test -f $(cmt_local_WorkArearchk_makefile); then \
	  $(MAKE) -f $(cmt_local_WorkArearchk_makefile) WorkArearchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_WorkArearchk_makefile) WorkArearchk
	$(echo) "(constituents.make) WorkArearchk done"

clean :: WorkArearchkclean ;

WorkArearchkclean :: $(WorkArearchkclean_dependencies) ##$(cmt_local_WorkArearchk_makefile)
	$(echo) "(constituents.make) Starting WorkArearchkclean"
	@-if test -f $(cmt_local_WorkArearchk_makefile); then \
	  $(MAKE) -f $(cmt_local_WorkArearchk_makefile) WorkArearchkclean; \
	fi
	$(echo) "(constituents.make) WorkArearchkclean done"
#	@-$(MAKE) -f $(cmt_local_WorkArearchk_makefile) WorkArearchkclean

##	  /bin/rm -f $(cmt_local_WorkArearchk_makefile) $(bin)WorkArearchk_dependencies.make

install :: WorkArearchkinstall ;

WorkArearchkinstall :: $(WorkArearchk_dependencies) $(cmt_local_WorkArearchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_WorkArearchk_makefile); then \
	  $(MAKE) -f $(cmt_local_WorkArearchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_WorkArearchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : WorkArearchkuninstall

$(foreach d,$(WorkArearchk_dependencies),$(eval $(d)uninstall_dependencies += WorkArearchkuninstall))

WorkArearchkuninstall : $(WorkArearchkuninstall_dependencies) ##$(cmt_local_WorkArearchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_WorkArearchk_makefile); then \
	  $(MAKE) -f $(cmt_local_WorkArearchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_WorkArearchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: WorkArearchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(WorkArea_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_make = $(bin)$(WorkArea_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(WorkArea_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(WorkArea_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(WorkArea_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(WorkArea_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(WorkArea_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(WorkArea_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(WorkArea_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(WorkArea_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(WorkArea_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(WorkArea_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(WorkArea_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(WorkArea_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_compile = $(bin)$(WorkArea_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(WorkArea_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(WorkArea_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(WorkArea_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(WorkArea_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(WorkArea_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(WorkArea_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(WorkArea_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(WorkArea_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(WorkArea_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(WorkArea_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(WorkArea_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(WorkArea_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(WorkArea_tag).make
