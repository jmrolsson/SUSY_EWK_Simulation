...
#cmt_local_tagfile_check_install_python_modules = $(WorkArea_tag)_check_install_python_modules.make
...
#cmt_local_tagfile_check_install_python_modules = $(WorkArea_tag).make
...
#cmt_final_setup_check_install_python_modules = $(bin)WorkArea_check_install_python_modulessetup.make
...
#cmt_final_setup_check_install_python_modules = $(bin)WorkAreasetup.make
cmt_local_check_install_python_modules_makefile = $(bin)check_install_python_modules.make
...
$(check_install_python_modulesactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.7.8/AtlasCore/20.7.8/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../python *.py ' -installdir=/afs/cern.ch/work/j/jolsson/SUSY_EWK_Simulation/Derivation/InstallArea/python/WorkArea -level=
