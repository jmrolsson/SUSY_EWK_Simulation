...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=WorkArea -version=WorkArea-00-00-00 -path=/afs/cern.ch/user/j/jolsson/work/SUSY_EWK_Simulation/Derivation  -no_cleanup $* >${cmtWorkAreatempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=WorkArea -version=WorkArea-00-00-00 -path=/afs/cern.ch/user/j/jolsson/work/SUSY_EWK_Simulation/Derivation  -no_cleanup $* >${cmtWorkAreatempfile}"
